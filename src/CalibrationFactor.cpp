...
void CCalibrationFactor::CF_Load()
{
    ...
    pDoc->Cal_Physical();
    m_CFA00 = ctx->ai.cal.a[0];
    m_CFB00 = ctx->ai.cal.b[0];
    m_CFC00 = ctx->ai.cal.c[0];
    m_CFP00.Format("%11.5f",ctx->ai.phy[0]);
    m_CFA01 = ctx->ai.cal.a[1];
    m_CFB01 = ctx->ai.cal.b[1];
    m_CFC01 = ctx->ai.cal.c[1];
    m_CFP01.Format("%11.5f",ctx->ai.phy[1]);
    m_CFA02 = ctx->ai.cal.a[2];
    m_CFB02 = ctx->ai.cal.b[2];
    m_CFC02 = ctx->ai.cal.c[2];
    m_CFP02.Format("%11.5f",ctx->ai.phy[2]);
    m_CFA03 = ctx->ai.cal.a[3];
    m_CFB03 = ctx->ai.cal.b[3];
    m_CFC03 = ctx->ai.cal.c[3];
    m_CFP03.Format("%11.5f",ctx->ai.phy[3]);
    m_CFA04 = ctx->ai.cal.a[4];
    m_CFB04 = ctx->ai.cal.b[4];
    m_CFC04 = ctx->ai.cal.c[4];
    m_CFP04.Format("%11.5f",ctx->ai.phy[4]);
    m_CFA05 = ctx->ai.cal.a[5];
    m_CFB05 = ctx->ai.cal.b[5];
    m_CFC05 = ctx->ai.cal.c[5];
    m_CFP05.Format("%11.5f",ctx->ai.phy[5]);
    m_CFA06 = ctx->ai.cal.a[6];
    m_CFB06 = ctx->ai.cal.b[6];
    m_CFC06 = ctx->ai.cal.c[6];
    m_CFP06.Format("%11.5f",ctx->ai.phy[6]);
    m_CFA07 = ctx->ai.cal.a[7];
    m_CFB07 = ctx->ai.cal.b[7];
    m_CFC07 = ctx->ai.cal.c[7];
    m_CFP07.Format("%11.5f",ctx->ai.phy[7]);
    m_CFA08 = ctx->ai.cal.a[8];
    m_CFB08 = ctx->ai.cal.b[8];
    m_CFC08 = ctx->ai.cal.c[8];
    m_CFP08.Format("%11.5f",ctx->ai.phy[8]);
    m_CFA09 = ctx->ai.cal.a[9];
    m_CFB09 = ctx->ai.cal.b[9];
    m_CFC09 = ctx->ai.cal.c[9];
    m_CFP09.Format("%11.5f",ctx->ai.phy[9]);
    m_CFA10 = ctx->ai.cal.a[10];
    m_CFB10 = ctx->ai.cal.b[10];
    m_CFC10 = ctx->ai.cal.c[10];
    m_CFP10.Format("%11.5f",ctx->ai.phy[10]);
    m_CFA11 = ctx->ai.cal.a[11];
    m_CFB11 = ctx->ai.cal.b[11];
    m_CFC11 = ctx->ai.cal.c[11];
    m_CFP11.Format("%11.5f",ctx->ai.phy[11]);
    m_CFA12 = ctx->ai.cal.a[12];
    m_CFB12 = ctx->ai.cal.b[12];
    m_CFC12 = ctx->ai.cal.c[12];
    m_CFP12.Format("%11.5f",ctx->ai.phy[12]);
    m_CFA13 = ctx->ai.cal.a[13];
    m_CFB13 = ctx->ai.cal.b[13];
    m_CFC13 = ctx->ai.cal.c[13];
    m_CFP13.Format("%11.5f",ctx->ai.phy[13]);
    m_CFA14 = ctx->ai.cal.a[14];
    m_CFB14 = ctx->ai.cal.b[14];
    m_CFC14 = ctx->ai.cal.c[14];
    m_CFP14.Format("%11.5f",ctx->ai.phy[14]);
    m_CFA15 = ctx->ai.cal.a[15];
    m_CFB15 = ctx->ai.cal.b[15];
    m_CFC15 = ctx->ai.cal.c[15];
    m_CFP15.Format("%11.5f",ctx->ai.phy[15]);
    m_C00 = _T("CH00, Load Cell");
    m_C01 = _T("CH01, Displacement");
    m_C02 = _T("CH02, LVDT1");
    m_C03 = _T("CH03, LVDT2");
    m_C04 = _T("CH04, Cell Pre.");
    m_C05 = _T("CH05");
    m_C06 = _T("CH06");
    m_C07 = _T("CH07");
    m_C08 = _T("CH08, Effect.Cell Pre.");
    m_C09 = _T("CH09, Drained Vol.");
    m_C10 = _T("CH10");
    m_C11 = _T("CH11");
    m_C12 = _T("CH12");
    m_C13 = _T("CH13");
...
void CCalibrationFactor::OnBUTTONCFUpdate() 
{
    DigitShowContext* ctx = GetContext();
    UpdateData(TRUE);
    ctx->ai.cal.a[0] = m_CFA00;
    ctx->ai.cal.b[0] = m_CFB00;
    ctx->ai.cal.c[0] = m_CFC00;
    ctx->ai.cal.a[1] = m_CFA01;
    ctx->ai.cal.b[1] = m_CFB01;
    ctx->ai.cal.c[1] = m_CFC01;
    ctx->ai.cal.a[2] = m_CFA02;
    ctx->ai.cal.b[2] = m_CFB02;
    ctx->ai.cal.c[2] = m_CFC02;
    ctx->ai.cal.a[3] = m_CFA03;
    ctx->ai.cal.b[3] = m_CFB03;
    ctx->ai.cal.c[3] = m_CFC03;
    ctx->ai.cal.a[4] = m_CFA04;
    ctx->ai.cal.b[4] = m_CFB04;
    ctx->ai.cal.c[4] = m_CFC04;
    ctx->ai.cal.a[5] = m_CFA05;
    ctx->ai.cal.b[5] = m_CFB05;
    ctx->ai.cal.c[5] = m_CFC05;
    ctx->ai.cal.a[6] = m_CFA06;
    ctx->ai.cal.b[6] = m_CFB06;
    ctx->ai.cal.c[6] = m_CFC06;
    ctx->ai.cal.a[7] = m_CFA07;
    ctx->ai.cal.b[7] = m_CFB07;
    ctx->ai.cal.c[7] = m_CFC07;
    ctx->ai.cal.a[8] = m_CFA08;
    ctx->ai.cal.b[8] = m_CFB08;
    ctx->ai.cal.c[8] = m_CFC08;
    ctx->ai.cal.a[9] = m_CFA09;
    ctx->ai.cal.b[9] = m_CFB09;
    ctx->ai.cal.c[9] = m_CFC09;
    ctx->ai.cal.a[10] = m_CFA10;
    ctx->ai.cal.b[10] = m_CFB10;
    ctx->ai.cal.c[10] = m_CFC10;
    ctx->ai.cal.a[11] = m_CFA11;
    ctx->ai.cal.b[11] = m_CFB11;
    ctx->ai.cal.c[11] = m_CFC11;
    ctx->ai.cal.a[12] = m_CFA12;
    ctx->ai.cal.b[12] = m_CFB12;
    ctx->ai.cal.c[12] = m_CFC12;
    ctx->ai.cal.a[13] = m_CFA13;
    ctx->ai.cal.b[13] = m_CFB13;
    ctx->ai.cal.c[13] = m_CFC13;
    ctx->ai.cal.a[14] = m_CFA14;
    ctx->ai.cal.b[14] = m_CFB14;
    ctx->ai.cal.c[14] = m_CFC14;
    ctx->ai.cal.a[15] = m_CFA15;
    ctx->ai.cal.b[15] = m_CFB15;
    ctx->ai.cal.c[15] = m_CFC15;
}
...
void CCalibrationFactor::OnBUTTONCFLoadFile() 
{
    ...
    if (CalLoadFile_dlg.DoModal()==IDOK)
    {
        ...
        if((err = fopen_s(&FileCalData,(LPCSTR)pFileName , _T("r"))) == 0)
        {
            ...
            for(i = 0;i<NUM_PARAM_MAX;i++){
                fscanf_s(FileCalData,_T("%d%lf%lf%lf"),&j,&ctx->ai.cal.a[i],&ctx->ai.cal.b[i],&ctx->ai.cal.c[i]);
            }
            fclose(FileCalData);
            CF_Load();
        }
